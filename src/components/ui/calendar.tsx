...
/**
 * shadcn's base-nova calendar on top of react-day-picker, with the registry's
 * icon placeholders swapped for lucide. Cell size and radius are CSS vars so
 * a caller can grow the cells for touch (`[--cell-size:2.75rem]`) without
